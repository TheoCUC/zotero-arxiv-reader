...
pref(
  ...
  '[{"id":"openai","name":"OpenAI","apiBaseUrl":"https://api.openai.com/v1","apiKey":"","model":"gpt-4o-mini","rpm":2000,"temperature":0.2}]',
);
...
pref(
  "extensions.zotero.arxiv-reader.translationParallelReassignOnFailure",
  true,
);
pref(
